...
public class CraftTileEntityTypes {
    ...
    public static final TileEntityTypeRegistryObject<ExtraTileEntityEnergyCube> CRAFT_ABSOLUTE_ENERGY_CUBE = CRAFT_TILE_ENTITY_TYPES.register(CraftBlocks.CRAFT_ABSOLUTE_ENERGY_CUBE, (pos, state) -> new ExtraTileEntityEnergyCube(CraftBlocks.CRAFT_ABSOLUTE_ENERGY_CUBE, pos, state), TileEntityMekanism::tickServer, TileEntityMekanism::tickClient);
    public static final TileEntityTypeRegistryObject<ExtraTileEntityEnergyCube> CRAFT_SUPREME_ENERGY_CUBE = CRAFT_TILE_ENTITY_TYPES.register(CraftBlocks.CRAFT_SUPREME_ENERGY_CUBE, (pos, state) -> new ExtraTileEntityEnergyCube(CraftBlocks.CRAFT_SUPREME_ENERGY_CUBE, pos, state), TileEntityMekanism::tickServer, TileEntityMekanism::tickClient);
    public static final TileEntityTypeRegistryObject<ExtraTileEntityEnergyCube> CRAFT_COSMIC_ENERGY_CUBE = CRAFT_TILE_ENTITY_TYPES.register(CraftBlocks.CRAFT_COSMIC_ENERGY_CUBE, (pos, state) -> new ExtraTileEntityEnergyCube(CraftBlocks.CRAFT_COSMIC_ENERGY_CUBE, pos, state), TileEntityMekanism::tickServer, TileEntityMekanism::tickClient);
    public static final TileEntityTypeRegistryObject<ExtraTileEntityEnergyCube> CRAFT_INFINITE_ENERGY_CUBE = CRAFT_TILE_ENTITY_TYPES.register(CraftBlocks.CRAFT_INFINITE_ENERGY_CUBE, (pos, state) -> new ExtraTileEntityEnergyCube(CraftBlocks.CRAFT_INFINITE_ENERGY_CUBE, pos, state), TileEntityMekanism::tickServer, TileEntityMekanism::tickClient);
