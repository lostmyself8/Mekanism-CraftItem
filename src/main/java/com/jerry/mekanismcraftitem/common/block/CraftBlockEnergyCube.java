...
public class CraftBlockEnergyCube extends BlockTile.BlockTileModel<TileEntityEnergyCube, CraftMachine<TileEntityEnergyCube>> {
    ...
    public CraftBlockEnergyCube(CraftMachine<TileEntityEnergyCube> type) {
